...
// provide uv coordinate for aoMap
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    // need to set true for transparent for alphaMap
    transparent: true,
...
for (let i = 0; i < 50; i++) {
  ...
  // random radius still in plane and not in the house
...
const tick = () => {
  ...
  ghost3.position.y = Math.sin(ghost2Angle * 5) + Math.sin(elapsedTime * 0.32);
